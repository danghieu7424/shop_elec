...
export default function Profile() {
  ...
  const loyaltyStatus = useMemo(() => {
    ...
    const nextLevelIndex = sortedLevels.findIndex(
      (lvl) => lvl.min > currentPoints
    );
              ...
              <div>
                <div className="flex justify-between text-xs text-gray-500 mb-1">
                  ...
                  <span className="font-medium text-blue-600">
                    {Math.round(loyaltyStatus.progress)}%
                  </span>
                </div>
                ...
                <div className="text-xs text-gray-500 flex gap-1 items-center bg-blue-50 p-2 rounded text-center justify-center">
                  ...
                  <span>
                    Tích thêm <b>{loyaltyStatus.pointsNeeded}</b> điểm để lên
                    hạng <b>{loyaltyStatus.nextLevel.name}</b>
                  </span>
                </div>
              </div>
            ) : (
        ...
        <div className="md:col-span-2">
          ...
          <div className="space-y-4">
            {orders.map((o) => (
              <Card
                key={o.id}
                className="p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:shadow-md transition-shadow"
              >
        ...
        >
          ...
          >
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-gray-500 bg-gray-100 py-2 px-3 rounded mt-2 break-all font-mono">
                {qrData.content}
              </p>
            </div>
